...
function updateReaction(s) {
    ...
    //const theDiv = $('#radio1-1-0001-1-3');
    // radio1/1/0001-1-3
    // radio1/1/0001-1-3
...
function toggleReaaction(reactantId, typeId, severityId, active) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (r) {
            //r.success && updateFoodReactionColor(reactantId, r.updatedColor);
            r.success && console.log("R SUCCESSFUL");
        }
    })
}
