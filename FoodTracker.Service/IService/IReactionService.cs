...
namespace FoodTracker.Service.IService
{
    public interface IReactionService
    {
        ...
        Dictionary<int, List<Reaction>> GetAllDayReactionsForSurroundingMonths(DateTime dateTime);
        ...
        Dictionary<string, bool> GetUserSafeDaysForSurroundingMonths(DateTime dt, string dateFormat = SD.DATE_FORMAT);
        ...
        Dictionary<int, List<ReactionIcon>> GetActiveIconsForSurroundingMonths(DateTime dateTime);
