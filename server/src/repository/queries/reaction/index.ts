...
import updateReactionSeverity from './updateReactionSeverity';
import updateReactionActive from './updateReactionActive';
...
export {
  ...
  updateReactionType,
  updateReactionSeverity,
  updateReactionActive,
  deleteReaction,
};
